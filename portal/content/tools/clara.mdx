...
An AI-enabled product intelligence tool for Research. CLARA reads your programme's Confluence space, drafts structured artefacts, and files them back into the Knowledge Base — so each team starts richer than the last.

CLARA — **C**onfluence **L**earning & AI **R**esearch **A**ssistant — is **Research-only** and **Confluence-only**. Design and Test outputs do not write to Confluence; the Knowledge Base is the Research phase's destination.
